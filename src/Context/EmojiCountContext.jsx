...
const EmojiCountContext = React.createContext({
  monthList: initialMonthsList,
  updateMonthCount: (monthId, increment = 1) => {
    console.log('Updating month count for:', monthId) // Debug log

    this.setState(prevState => ({
      monthList: prevState.monthList.map(month =>
        month.id === monthId
          ? {...month, count: month.count + increment}
          : month
      ),
    }))
  }
...
export default EmojiCountContext